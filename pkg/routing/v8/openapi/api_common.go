...
/*
GetHealth Health status of the service
Returns the health of the service
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return HealthResponseOkSchema
*/
func (a *CommonApiService) GetHealth(ctx _context.Context) (HealthResponseOkSchema, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  HealthResponseOkSchema
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		newErr := GenericOpenAPIError{
			...
			var v HealthResponseFailSchema
...
/*
GetVersion Full version of the API
Returns the version of the service
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return VersionResponse
*/
func (a *CommonApiService) GetVersion(ctx _context.Context) (VersionResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
