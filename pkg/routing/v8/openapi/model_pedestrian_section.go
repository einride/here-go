...
package routingv8
// PedestrianSection Represent a section of a route
type PedestrianSection struct {
	...
	Departure PedestrianDeparture `json:"departure"`
	Arrival PedestrianDeparture `json:"arrival"`
	...
	Transport PedestrianTransport `json:"transport"`
	// Spans attached to a `Section` describing pedestrian content. 
	Spans []PedestrianSpan `json:"spans,omitempty"`
}
