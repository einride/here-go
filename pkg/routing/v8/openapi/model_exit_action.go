...
package routingv8
// ExitAction An action to leave a roundabout or highway.  * `exit`: exit maneuver, such as \"Take the left exit to\" * `roundaboutExit`: roundabout exit maneuver, such as \"Take the third exit of the roundabout onto\" 
