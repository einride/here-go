...
package routingv8
// OffsetAction An action to be performed at or during a specific portion of a section.  * `depart`: departure maneuver, such as \"Start at\" * `arrive`: arrival maneuver, such as \"Arrive at\" * `continue`: continue maneuver, such as \"Continue on\" * `board`: board a transport, such as \"Board ferry\" 
